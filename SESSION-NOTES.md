...
**Stand: Top-10 + R11 (Bestattungsarten) + SH-Frist-Fix. Loop läuft weiter (Bolle 11.06.), als Nächstes Rang 13 (Stadtseiten: Berlin).** Backlog: Hamburg-Extern-Verifikationen, Consent-Vereinheitlichung (eigener Block), Fristen-MITTEL 4-6 (§30-III-Testament-Satz, FAQ-Q6-Beweislast, Sicherungsmaßnahmen-Hinweis), tracking.js-Plausible-Header.

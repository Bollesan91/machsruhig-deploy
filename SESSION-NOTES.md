...
**Stand: Top-10 + R11 (Bestattungsarten) + SH-Frist-Fix. Loop läuft weiter (Bolle 11.06.), Stadtseiten-Welle: Berlin ✓, als Nächstes München.** Backlog NEU: Berlin HOCH-4 (Träger-Attribution/Ehrenmäler-Abgleich), Korridor-Erd-Untergrenze 1.100 vs. 939 erklären, GERING-Politur (mr-table-Klasse, Meta-Fragment, Anrede-Mix). Backlog: Hamburg-Extern-Verifikationen, Consent-Vereinheitlichung (eigener Block), Fristen-MITTEL 4-6 (§30-III-Testament-Satz, FAQ-Q6-Beweislast, Sicherungsmaßnahmen-Hinweis), tracking.js-Plausible-Header.

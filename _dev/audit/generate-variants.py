...
VARIANTS = {
    'bestatter-angebot-vergleichen': {
        'title': 'Bestatter-Angebot vergleichen: Was zählt wirklich? | machsruhig',
    ...
    'was-muss-im-kostenvoranschlag-stehen': {
        ...
        'intro_section_p': '<p>Ein Kostenvoranschlag ist rechtlich eine <em>unverbindliche Schätzung</em> (§ 632 Abs. 3 BGB) — er ist kein Festpreis. Trotzdem ist er die Grundlage deiner Entscheidung. Damit du auf seiner Basis vernünftig entscheiden kannst, muss er bestimmte Mindestangaben enthalten.</p><p>Wenn der Bestatter dir nur eine Endsumme mit drei Stichpunkten gibt („Sarg, Beisetzung, Trauerfeier — 5.800 €"), dann ist das kein Kostenvoranschlag, sondern eine Pauschalrechnung. Bitte um eine aufgeschlüsselte Version. Seriöse Bestatter machen das ohne Murren — sie haben das Format ohnehin schon in ihrer Software.</p>',
        'faq_overrides': [
            ('Ist ein Bestatter-Kostenvoranschlag rechtlich bindend?', 'Nein, ein Kostenvoranschlag ist nach § 632 Abs. 3 BGB eine unverbindliche Schätzung. Der Bestatter darf vom Voranschlag abweichen, muss aber „wesentliche Überschreitungen" rechtzeitig anzeigen. Faustregel: Bei mehr als 15–20 % Mehrkosten muss er dich informieren.'),
    ...
    'bestatter-rechnung-pruefen': {
        ...
        'intro_section_p': '<p>Ein Kostenvoranschlag ist unverbindlich (§ 632 Abs. 3 BGB) — die endgültige Rechnung darf davon abweichen. Aber nicht beliebig. Der Bestatter muss „wesentliche Überschreitungen" rechtzeitig anzeigen, damit du noch reagieren kannst.</p><p>Als Faustregel gilt: Abweichungen bis 10 % sind im Rahmen, 10–20 % sollten begründet sein, über 20 % brauchen eine ausdrückliche Anzeige vor Beauftragung. Wenn die Rechnung deutlich höher ausfällt als der Voranschlag und der Bestatter dich darüber nicht informiert hat, hast du gute Chancen, die Differenz nicht zahlen zu müssen.</p>',
        'faq_overrides': [
            ('Wie hoch darf eine Bestatter-Rechnung über dem Voranschlag liegen?', 'Faustregel: Bis 10 % gilt als üblich, 10–20 % sollte der Bestatter begründen, ab 20 % muss er „wesentliche Überschreitungen" vor der Leistungserbringung anzeigen (§ 650 BGB analog). Ohne Anzeige bist du nicht verpflichtet, den Mehrbetrag zu zahlen.'),
    ...
    'erdbestattung-angebot-pruefen': {
        ...
        'faq_overrides': [
            ('Was kostet eine Erdbestattung in Deutschland?', 'Eine Erdbestattung kostet typisch 4.500–9.500 € (Stand 2026). Die Spanne entsteht hauptsächlich durch regionale Friedhofsgebühren und die Wahl des Sargs. In Bayern liegt der Schnitt eher bei 6.000–11.000 €, in Mecklenburg-Vorpommern bei 3.500–7.500 €.'),
            ('Welche Pflicht-Posten sind in einem Erdbestattung-Angebot?', 'Bestatterleistungen, Abholung + Überführung, hygienische Versorgung, Sarg, Friedhofsgebühren (Grab + Nutzungsrecht + Beisetzung), Beisetzungs-Service und mehrere Sterbeurkunden. Optional sind Trauerfeier, Floristik, Aufbahrung und Grabstein.'),
        ]
    },
    'feuerbestattung-angebot-pruefen': {
        ...
        'intro_section_p': '<p>Bei einer Feuerbestattung kommen zwei spezielle Posten dazu, die du im Angebot finden solltest: <strong>Kremationsgebühren</strong> (300–550 €) und die gesetzlich vorgeschriebene <strong>zweite Leichenschau</strong> (50–150 €). Letztere ist Pflicht vor jeder Einäscherung und wird oft im Krematoriums-Posten verrechnet — manchmal aber auch separat ausgewiesen.</p><p>Dafür entfällt der teure Sarg — bei Feuerbestattung reicht ein einfacher Verbrennungssarg (600–1.800 € statt 800–2.200 € bei Erdbestattung). Auch die Friedhofsgebühren sind in der Regel niedriger, weil ein Urnengrab weniger Platz braucht als ein Sarggrab. Die typische Preisspanne liegt bei 3.500–7.500 €.</p><p>Ein vollständiges Feuerbestattung-Angebot sollte diese Pflicht-Posten klar ausweisen:</p><ul><li>Bestatterleistungen + Abholung + Versorgung</li><li>Verbrennungssarg</li><li>Krematorium (inkl. zweiter Leichenschau)</li><li>Urne</li><li>Friedhofsgebühren (Urnengrab + Beisetzung)</li><li>Sterbeurkunden</li></ul>',
        'faq_overrides': [
            ...
            ('Was ist die zweite Leichenschau und kostet sie extra?', 'Die zweite Leichenschau ist die gesetzlich vorgeschriebene zweite ärztliche Untersuchung vor einer Einäscherung. Sie kostet 50–150 € und wird meist im Krematoriums-Posten verrechnet — manchmal aber auch separat im Angebot ausgewiesen. Frage nach, falls du sie nicht findest.'),
        ]
    },

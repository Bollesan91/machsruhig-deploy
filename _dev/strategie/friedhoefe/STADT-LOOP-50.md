...
- **OFFEN Phase 2 (auf Bolle-Go):** Entdoppeln — Recht/Friedhof-Blöcke auf Bestatter-Stadtseiten zu Teaser+Link kürzen (Kannibalisierung). Editorisch + nicht gratis (Tiefe hilft Ranking) → erst **1-Stadt-Test mit unabhängigem Review**, dann ggf. Sweep.

...
32. **Tote externe Quelllinks sind ein eigener, mechanischer Korrektheitsdefekt** (nicht vom statischen Linter gefangen). Fund 15.06.: 3 tote test.de-Artikel-URLs (404) auf 4 Live-Seiten (freiburg/karlsruhe/dresden/hannover) → auf den lebenden Hub `test.de/thema/bestattung/` umgebogen. test.de rotiert Artikel-URLs stark; Themen-Hubs sind stabiler. Kandidat für einen netzgestützten Link-Check (außerhalb des statischen Linters).

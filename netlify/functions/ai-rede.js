...
- Länge: kurz ≈ 450 Wörter, mittel ≈ 650 Wörter, lang ≈ 850 Wörter — Wortzahl anpeilen, nicht deutlich unterschreiten (die Längenwahl ist ein Versprechen an den Nutzer). Lieber inhaltlich verdichten als mit Floskeln auffüllen.
...
function buildUserMessage(type, data, section) {
  ...
  if (type === 'trauerrede') {
    ...
    parts.push(`Gewünschte Länge: ${data.length || 'mittel'} (kurz≈450W, mittel≈650W, lang≈850W)`);
